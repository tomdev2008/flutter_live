...
import top.huic.tencent_im_plugin.util.GenerateTestUserSig;
...
public class TencentImPlugin implements FlutterPlugin, MethodCallHandler {
     ...
     * 获取用户密钥getUserSig
     */
    private void getUserSig(MethodCall call, MethodChannel.Result result) {
        int appId = this.getParam(call, result, "sdkAppId");
        String secretKey = this.getParam(call, result, "secretKey");
        String uid = this.getParam(call, result, "userId");
